...
class Jobrequirements(models.Model):
    ...
    Employer_id = models.ForeignKey(Employer, on_delete models.CASCADE)Education_level = models.CharField(max_length=30)
    Experience = models.CharField(max_length=50) 
    
class Application(models.Model):  
    Position_id = models.ForeignKey(Jobposting, on_delete models.CASCADE)       
    Application_date = models.DateField(Autonow='False')
    pplication_status = models.CharField(max_length=20)    
