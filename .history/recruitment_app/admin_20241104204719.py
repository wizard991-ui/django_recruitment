...
from .models import Applicant,Employer,Jobposting,Qualification,Application,Jobrequirements
...
class recruitment_jobrequirements(admin.ModelAdmin):
    list_display=('Position_id','Employer_id','Education_level','Experience')
...
admin.site.register(Application,recruitment_application)
admin.site.register(Qualification,recruitment_qualification)
admin.site.register(Job Requirements,recruitment_jobrequirements)
