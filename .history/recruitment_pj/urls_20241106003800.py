...
from recruitment_app.views import index_view,applicant_view,jobposting_view,employer_view,jobrequirements_view, qualification_view, application_view,add_applicant_View,add_employer_view, add_jobposting_view,add_qualification_view,add_jobrequirements_view
...
urlpatterns = [
    ...
    path('addjorequirement/',add_jobrequirements_view, name ='addrequirement_vie')
]
