...
from recruitment_app.views import index_view,add_applicant_View,add_employer_view, add_jobposting_view,add_qualification_view,add_jobrequirements_view,add_application_view
