...
from recruitment_app.views import index_view,applicant_view,jobposting_view,employer_view,jobrequirements_view, qualification_view, application_view,add_applicant_View,add_employer_view, add_j
